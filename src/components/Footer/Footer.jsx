  ...
  return (
    <footer className="text-white py-8 px-[12vw] md:px-[7vw] lg:px-[20vw]">
      <div className="container mx-auto text-center">
        {/* Name / Logo */}
        <h2 className="text-xl font-semibold text-purple-500">Nazmus Rakib</h2>
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-6">
          {[
            ...
            { icon: <FaLinkedin />, link: "https://www.linkedin.com/in/nazmus-rakib-ashfi-378a74369" },
            // { icon: <FaInstagram />, link: "https://www.instagram.com/coding_.master/" },
            { icon: <FaGithub />, link: "https://github.com/Rakib-Hossain10" },
        ...
        <p className="text-sm text-gray-400 mt-6">
          © 2025 Nazmus Rakib. All rights reserved.
        </p>
      </div>
    </footer>
  );
