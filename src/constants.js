...
//Job Section Logo's
import internlogo from "./assets/Job_logo/intern pic.jpg";
...
import colablogo from "./assets/tool_logo/colab.png";
import jupyterlogo from "./assets/tool_logo/Jupyter.png";

import numpyLogo from "./assets/Ai_logo/numpy.jpg";
import pandasLogo from "./assets/Ai_logo/pandas.png";
import sklearnLogo from "./assets/Ai_logo/Scikit_learn.png";
import tensorflowLogo from "./assets/Ai_logo/TensorFlow.png";
import kerasLogo from "./assets/Ai_logo/keras.png";
import cnnLogo from "./assets/Ai_logo/CNN.png";
import transferLearningLogo from "./assets/Ai_logo/transfer learning.png";
import matplotlibLogo from "./assets/Ai_logo/matplotlib.png";
import seabornLogo from "./assets/Ai_logo/seaborn.png";

import brainstokelogo from "./assets/project_logo/brainStroke.png";
import wheatplantlogo from "./assets/project_logo/Wheat plant.png";
import TB from "./assets/project_logo/TB.png";

//Computer Vision
import visionstreamlogo from "./assets/project_logo/vehicle1.png";
import pcbvisionlogo from "./assets/project_logo/pcb.png";
...
export const SkillsInfo = [
  {
    ...
    skills: [
      ...
      { name: "Transfer Learning", logo: transferLearningLogo },
...
export const job = [
  {
    ...
    company: "Shanghai Qianquan Cultural Technology Co., Ltd.",
    date: "",
    drivelink:
      "https://drive.google.com/file/d/1aMroF5sNx02G3OydxaBMUZJjdryE1Qrr/view?usp=drive_link",
    desc: "Successfully completed a Software Engineering Internship at Shanghai Qianquan Cultural Technology Co., Ltd, gaining hands-on experience in software development, contributing to project deliverables, and maintaining a high standard of professionalism throughout the internship.",
    skills: [
...
export const publications = [
  {
    id: 0,
    role: "A Real-Time Emergency Communication Framework Using WebSockets and the MERN Stack",
    company: "Journal of Computer, Software, and Program",
    date: "",
    drivelink: "https://doi.org/10.69739/jcsp.v2i2.1159",
    desc: "This study presents a hybrid, WebSocket-driven emergency communication framework that integrates real-time chat, SOS alerts, live geolocation streaming, and voice evidence within a single secure platform. Built on the MERN stack, the system leverages persistent bidirectional socket connections to minimize latency and ensure reliable delivery under time-critical conditions. A Comparative analysis with recent IoT-based emergency frameworks highlights improved responsiveness and richer contextual support. The proposed architecture offers a practical, privacy-preserving solution for emergency communication in public safety, healthcare, and disaster-response scenarios.",
    skills: [
...
export const experiences = [
  {
    ...
    date: "",
    drivelink:
      "https://drive.google.com/file/d/14lTl9hQrHjIVssj4Zmo0C18R3AlJbXSv/view?usp=sharing",
  ...
  },
  {
    ...
    date: "",
    drivelink:
      "https://drive.google.com/file/d/1jOB1trUrvK2FWhSkggmO87T3XemN7MA8/view?usp=sharing",
...
export const projects = [
  {
    id: 0,
    title: "VisionStream AI: Edge-Optimized Vehicle Analytics",
    description:
      "A real-time computer vision system for vehicle detection, multi-object tracking, and speed estimation, designed with a production-style microservice architecture. The project separates AI inference and user interface into two independent services: a FastAPI backend for frame-by-frame processing and a Streamlit dashboard for live monitoring and analytics. It uses YOLOv11n exported to ONNX for efficient vehicle detection, ByteTrack for persistent identity tracking across frames, and a custom speed-estimation pipeline based on scene-calibrated pixel-to-meter conversion.Optimized for edge deployment, the system is engineered to run within a strict 512MB RAM footprint, making it suitable for NVIDIA Jetson devices and other low-power AI gateways. The backend is built with lightweight dependencies such as OpenCV Headless and supports stateless frame streaming similar to real CCTV-to-edge communication. The frontend provides a modern glassmorphism-style dashboard that visualizes processed frames, object telemetry, throughput, and latency in real time.The project also emphasizes deployment readiness through ONNX interoperability for TensorRT acceleration, cloud-hosted demonstration support, and CI/CD integration with GitHub Actions. Performance benchmarks on a cloud CPU environment show stable low-memory operation and real-time analytics capability, with significantly higher throughput expected on Jetson hardware.",

    image: visionstreamlogo,
    tags: [
      "Computer Vision",
      "YOLO",
      "YOLOv11",
    ...
    github:
      "https://github.com/Rakib-Hossain10/Edge-Optimized-Real-Time-Vehicle-Analytics-Pipeline",
    webapp: "https://visionstream-frontend.onrender.com/",
  },
...

  {
    ...
    title: "PCB Vision AI",
    description:
      "An end-to-end computer vision system for automated PCB quality inspection, designed to detect six common manufacturing defects in real time using a custom-trained YOLOv11n model. The project follows a decoupled, production-style architecture with a FastAPI backend for inference and API serving, and a React + Vite + Tailwind CSS frontend for an interactive user experience. This separation improves scalability, deployment flexibility, and maintainability while simulating a real industrial AI workflow.The detection pipeline is optimized for identifying critical PCB defects including missing hole, mouse bite, open circuit, short, spur, and spurious copper. Built with PyTorch and Ultralytics YOLO, the model is trained on a custom PCB defect dataset to support reliable visual inspection in manufacturing environments. The backend handles model inference efficiently, while the frontend provides a modern responsive interface for submitting images and visualizing defect predictions in real time.The project also demonstrates deployment readiness through cloud hosting on Render and Vercel, CI/CD automation using GitHub Actions, and organized modular structure across backend, frontend, model, and output layers. Altogether, it showcases practical deep learning, full-stack deployment, and industrial computer vision application development for intelligent quality control systems.",
    ...
    github:
      "https://github.com/Rakib-Hossain10/PCB-Vision-AI-Industrial-Defect-Detection-System",
    webapp: "https://pcb-vision-ai-industrial-defect-det.vercel.app/",
  },
...

  {
    ...
    github:
      "https://github.com/Rakib-Hossain10/Wheat-Plant-Disease-Classification-",
